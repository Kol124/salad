...
interface signupData { email: string, password: string, handle: string, confirmPassword: string }
interface loginData { email: string, password: string }
interface error { email?: string, password?: string, handle?: string, confirmPassword?: string }
